...
export const SAMPLE_DOCS: SampleDoc[] = [
  ...
  },
  {
    ...
    type: "invoice",
    title: "Invoice",
    description: "Breakdown of the balance due with line items and a running total.",
  },
]
...
export function sampleDocument(
  ...
  if (type === "invoice") {
    ...
    doc.sections = [
      {
        ...
        items: [
          {
            id: uid("it"),
            description: "Balance due on three (3) plots of land (measuring 1800SQM)",
            amount: 4200000,
          },
          {
            id: uid("it"),
    ...
    doc.thanks = "Thank you for subscribing to Southern Atlantic Estate."
    return doc
  }
  ...
  doc.sections = [
    {
      ...
      items: [
        {
          id: uid("it"),
          description: "Amount paid for three (3) plots of land (measuring 1800SQM)",
          amount: 3700000,
        },
        { id: uid("it"), description: "Balance payment for land", amount: 500000 },
      ],
    },
    {
      id: uid("sec"),
      ...
      items: [
        ...
        { id: uid("it"), description: "Amount to be paid for Development levy", amount: 900000 },
        { id: uid("it"), description: "Total balance to be paid", amount: 1850000 },
      ],
    },
  ]
  doc.closing =
  ...
  doc.thanks = "Thank you for subscribing to Southern Atlantic Estate a development by Silver Pacific Homes."
  return doc
}
